...
def createTask(description, MettingPIN, block_pin,is_private,token,key):
    item = {
        "request" : 'create',
        "permanent" : True,
        "is_private" : False,
...
def editTask(room, description, pin,is_private, block_pin,token,key):
    item = {
        "request" : 'edit',
        "room": room,
...
def destroyTask(room,block_pin,key):
    item = {
        "request" : 'destroy',
        "room": room,
        "secret": block_pin,
...
def blockTask(room,block_pin,key):
    item = {
        "request" : 'edit',
        "room": room,
        "new_pin": block_pin,
