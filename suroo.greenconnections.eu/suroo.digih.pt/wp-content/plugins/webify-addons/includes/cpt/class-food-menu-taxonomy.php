 ...
 * @author        themebubble
 */
if(!class_exists('Webify_Food_Menu_Taxonomy')) {
  class Webify_Food_Menu_Taxonomy {

    protected $post_type = 'menu';
    ...
    public function register_taxonomy() {
      $this->add_taxonomy('Categories','menu-category',$this->post_type);
    }
