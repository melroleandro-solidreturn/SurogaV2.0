 ...
 * @author        themebubble
 */
if(!class_exists('Webify_Portfolio_CPT')) {
  class Webify_Portfolio_CPT {
    ...
    function register_post_type() {
      ...
      $labels = array(
        'name'               => esc_html__( 'Portfolio', 'webify-addons' ),
        'singular_name'      => esc_html__( 'Portfolio', 'webify-addons' ),
        ...
        'parent_item_colon'  => '',
        'menu_name'          => esc_html__( 'Portfolio', 'webify-addons' )
      );
      ...
      $args = apply_filters( 'webify_register_post_type_portfolio_arg', $args );
      register_post_type ( 'portfolio', $args);

    }

  }
  new Webify_Portfolio_CPT();
}