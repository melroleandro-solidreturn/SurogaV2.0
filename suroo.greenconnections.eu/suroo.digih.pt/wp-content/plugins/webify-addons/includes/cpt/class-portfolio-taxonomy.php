 ...
 * @author        themebubble
 */
if(!class_exists('Webify_Portfolio_Taxonomy')) {
  class Webify_Portfolio_Taxonomy {
    ...
    public function register_taxonomy() {
      $this->add_taxonomy('Categories','portfolio-category',$this->post_type);
    }
