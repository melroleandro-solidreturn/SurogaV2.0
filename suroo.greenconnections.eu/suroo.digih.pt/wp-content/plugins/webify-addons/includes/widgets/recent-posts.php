...
CSF::createWidget('webify_recent_posts', array(
  'title'       => esc_html__('- Webify Recent Posts', 'webify-addons'),
  'classname'   => 'tb-widget-recent-posts',
  'fields'      => array(
    array(
      'id'      => 'title',
      'type'    => 'text',
    ...
    array(
      ...
      'default' => 'DESC',
      'options' => array(
        'DESC' => esc_html__('DESC', 'webify-addons'),
        'ASC'  => esc_html__('ASC', 'webify-addons'),
      ),
      'title' => esc_html__('Order', 'webify-addons')
    ),
    array(
      'id'      => 'post_count',
      'type'    => 'text',
...
if(!function_exists( 'webify_recent_posts' ) ) {
  function webify_recent_posts( $args, $instance ) {
