...
<!-- Start Site Header -->
<header class="tb-site-header tb-sticky-logo <?php echo (webify_get_opt('header-full-width')) ? 'tb-full-width':'tb-default-width'; ?> tb-style1 tb-transparent-header <?php echo (webify_get_opt('header-sticky')) ? 'tb-sticky-header':'tb-sticky-disabled'; ?> tb-color2">
