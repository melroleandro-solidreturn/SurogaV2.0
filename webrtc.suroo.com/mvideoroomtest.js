...
$(document).ready(function() {
	...
	$('#toggle-view-1').click(function() {
        // Alternar visibilidade entre vídeo local e remoto
        $('#video-local').toggleClass('hide');
        $('#video-remoto').toggleClass('hide');
    });

	$('#toggle-view-2').click(function() {
        // Alternar visibilidade entre vídeo local e remoto
        $('#video-local').toggleClass('hide');
        $('#video-remoto').toggleClass('hide');
    });
						...
						janus.attach(
							{
								...
								onlocaltrack: function(track, on) {
									...
									$('#frame').css({
										...
										'position': 'absolute',
										'top': '0.5%',  /* Ajuste para centralizar verticalmente */
										'left': '5%'    /* Ajuste para centralizar horizontalmente */
									});
									$('#videos').removeClass('hide').show();
									if($('#mute').length === 0) {

										// Adicionar botões dentro da div button-container
										$('.button-container').append('<button class="btn  btn-xs" id="mute"><i class="fa fa-volume-off"></i></button>');
										$('#mute').click(toggleMute);
										
										$('.button-container').append('<button class="btn  btn-xs" id="toggle-view-1"><i class="fa fa-exchange"></i></button>');
										$('#toggle-view-1').click(function() {
											// Alternar visibilidade entre vídeo local e remoto
											$('#video-local').toggleClass('hide');
											$('#video-remoto').toggleClass('hide');
										...
										$('.button-container').append('<button class="btn btn-xs" id="unpublish"><i class="fa fa-video-camera"></i></button>');
										$('#unpublish').click(unpublishOwnFeed);

										$('.button-container').append('<button class="btn btn-xs" id="chat-view"><i class="fa fa-comment"></i></button>');
										$('#chat-view').click(function() {
											// Alterna a visibilidade do chat
											$('#chat').toggleClass('show');
										});

										// Adicionar o dropdown de largura de banda
										$('.top-button-container').append(`
											<button id="bitrateset" class="btn btn-xs dropdown-toggle" data-toggle="dropdown">
											<i class="fa fa-signal"></i> <span class="caret"></span>
											</button>
											<ul class="dropdown-menu" role="menu" id="bitrate">
								...
								oncleanup: function() {
									...
									$('#videolocal').html('<img src="Water-Drop-.png" alt="Video not published" id="published-image"><div class="button-container"></div>');
									$('.button-container').append('<button class="btn btn-xs" id="publish"><i class="fa fa-video-camera"></i></button>');
...
function publishOwnFeed(useAudio) {
	...
	$('#published-image').toggleClass('hide');
...
function toggleMute() {
	...
	$('#mute').html(muted ? '<i class="fa fa-volume-up"></i>' : '<i class="fa fa-volume-off"></i>');
}
